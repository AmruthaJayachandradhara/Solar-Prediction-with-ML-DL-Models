...
from config import (
    RAW_PVGIS_HOURLY_CSV, RAW_NASA_2019_CSV, RAW_NASA_2020_CSV,
    RAW_PVGIS_TMY_CSV, PROCESSED_CSV, CLEANING_REPORT, ensure_dirs,
)

# ──────────────────────────────────────────────────────────────────────────────
# PATHS  (imported from config.py — edit DATA_DIR there or set SOLAR_DATA_DIR)
# ──────────────────────────────────────────────────────────────────────────────
PVGIS_HOURLY   = RAW_PVGIS_HOURLY_CSV
NASA_2019      = RAW_NASA_2019_CSV
NASA_2020      = RAW_NASA_2020_CSV
PVGIS_TMY      = RAW_PVGIS_TMY_CSV
